...
export const dataProyectos: DataProjects[] = [
  {
    ...
    topics: ["Expressjs", "Mysql", "Nodejs", "Postgresql", "Swagger"],
  ...
  // },
  {
    ...
    topics: ["Chartjs", "Framer-motion", "Material-react-table", "React"],
  ...
  },
  {
    ...
    topics: ["Astro", "Daisyui", "React", "Typescript", "Tailwindcss"],
  ...
  },
  {
    ...
    topics: ["Binary", "Calculator", "Hexadecimal", "Octal", "Python"],
  ...
  },
  {
    ...
    topics: ["Chalk-cli", "Commanderjs", "Inquirer", "Inquirer-prompt"],
