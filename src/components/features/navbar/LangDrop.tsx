    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className={`
          ...
          transition-colors duration-200 flex items-center gap-2 border border-white/10
        `}
        whileTap={{ scale: 0.95 }}
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className={`
                absolute mt-2 w-48 bg-gradient-to-b from-gray-900/95 to-gray-800/95 
                backdrop-blur-xl shadow-2xl rounded-xl z-20 border border-white/10 
                overflow-hidden
                ...
                {Object.entries(languages).map(
                  ([key, { label, img }], index) => (
                    <motion.button
                      ...
                      ${selectedLang === key ? "bg-blue-500/20 text-blue-400" : "text-gray-300"}
                    `}
