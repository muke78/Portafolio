...
export const Toast: React.FC<ToastProps> = ({ currentLocale }) => {
    ...
    useEffect(() => {
        ...
        const isToastClosed = JSON.parse(localStorage.getItem('toastClosed') || 'false')
        if (!isToastClosed) {
            setVisible(true)
        }
    }, [])
            ...
            {visible && (
                <>
                        ...
                        <div role="alert">
                            <div className="flex">
                                ...
                                <div className="ms-3 text-sm font-normal">
                                    <span className="mb-2 text-lg font-semibold text-base-content">{i18n.TOAST.TOAST_TITLE}</span>
                    ...
                    <div id="toast-top-right"
                        ...
                        role="alert">
                        <div className="text-lg font-normal text-transparent bg-gradient-to-r from-primary via-secondary to-accent">Top right positioning.</div>
                    </div>
                </>
