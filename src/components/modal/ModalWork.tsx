  ...
  return (
    <>
      ...
      >
        ...
        <div className="card backdrop-blur-[40px] backdrop-saturate-[180%] rounded-b-lg py-5 px-5  border border-neutral-500 z-50">
          {/* <!-- Modal header --> */}
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
            <h3 className="text-xl font-semibold">Experiencia</h3>
            <form method="dialog">
              <button className="btn btn-sm rounded-lg text-sm ms-auto inline-flex justify-center items-center">
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
          ...
          <div className="p-4 md:p-5">
            <ol className="relative border-s ms-3.5 mb-4 md:mb-5">
              <li className="mb-10 ms-8">
                ...
                <time className="flex items-start mb-3 text-sm font-normal leading-none text-neutral-500">
